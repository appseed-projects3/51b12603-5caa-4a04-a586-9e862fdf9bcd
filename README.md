...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-05-14 10:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/51b12603-5caa-4a04-a586-9e862fdf9bcd.git
$ cd 51b12603-5caa-4a04-a586-9e862fdf9bcd
```
